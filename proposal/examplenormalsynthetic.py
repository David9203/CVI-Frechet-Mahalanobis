...
car=pd.read_excel("/home/nestord.rendon/nestor/CVI-Frechet-Mahalanobis/Anotherindicestest/SyntheticData/info1_real_normal_noise.xlsx")  

for i in range(500,900,10):
  admis, cpred =iterateindex(i,i+10)
  with open("/home/nestord.rendon/nestor/normalnoise/"+"admsco_"+str(i)+"_"+str(i+10)+".txt", 'w') as f:
      for s in admis:
          f.write(str(s) + '\n')
  with open("/home/nestord.rendon/nestor/normalnoise/"+"clusterspred_"+str(i)+"_"+str(i+10)+".txt", 'w') as f:
      for s in cpred:
          f.write(str(s) + '\n')
